        ...
        <nav className={`fixed w-full z-50 transition-all duration-300 top-0 left-0 glass-nav py-4 ${isScrolled ? "bg-[#0f172a]/80" : "bg-[#0f172a]/40"}`}>
            <div className="container mx-auto px-6 flex justify-between items-center relative">
                ...
                <div className="hidden md:flex space-x-8 items-center z-20">
                    ...
                    <Link href="/messages" className="text-sm font-medium text-gray-300 hover:text-white transition tracking-wide uppercase hover:underline underline-offset-4 decoration-indigo-500 relative">
                        📩 Messages
                    </Link>
